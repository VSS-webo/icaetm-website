    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="
          ...
          mb-12 text-base md:text-lg
          max-w-3xl mx-auto
        ">
          Registration fees for ICAETM 2026 participants.
          Early bird rates apply before the specified date.
        </p>
        ...
        ">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gradient-to-r from-indigo-100 to-sky-100 text-slate-700">
                <th className="py-4 px-5 font-medium border-r border-slate-500">
                  Participant
                </th>
                <th className="py-4 px-5 font-medium border-r border-slate-500">
                  Early Bird (Before 01 June 2026)
                </th>
                <th className="py-4 px-5 font-medium">
                  Registration (After 01 June 2026)
                </th>
              </tr>
            </thead>
            ...
            <tbody className="divide-y divide-slate-200">
              {[
                ...
                >
                  ...
                  <td className="py-4 px-5 text-slate-700 border-r border-slate-200">
                    {early}
                  </td>
